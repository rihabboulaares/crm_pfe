...
export const SHADOW = {
  ...
  card: "0 2px 12px rgba(15,23,42,.06),0 1px 3px rgba(15,23,42,.04)",
  cardHov: "0 8px 30px rgba(15,23,42,.10),0 2px 8px rgba(15,23,42,.06)",
  sm: "0 1px 4px rgba(15,23,42,.06)",
};
